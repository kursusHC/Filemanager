		...
		if(data){
			...
			if($('#fileinfo').data('view') == 'grid'){
				...
				for(key in data){
					...
					result += '<li class="' + cap_classes + '"' + title + 'data-path="'+data[key]['Path']+'"><div class="clip"><img src="' + data[key]['Preview'] + '" width="' + scaledWidth + '" alt="' + data[key]['Path'] + '" data-path="' + data[key]['Path'] + '" /></div><p>' + data[key]['Filename'] + '</p>';
